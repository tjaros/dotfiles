...
(setq user-full-name "Tomáš Jaroš"
      user-mail-address "xjaros2@fi.muni.cz")
...
(setq doom-theme 'doom-one
      doom-font (font-spec :family "Fira Code Nerd Font Mono" :size 14)
      )
...
(set-email-account! "mail.muni.cz"
  '((mu4e-sent-folder       . "/mail.muni.cz/492880/sent")
    ...
    (user-mail-address      . "492880k@mail.muni.cz")    ;; only needed for mu < 1.4
